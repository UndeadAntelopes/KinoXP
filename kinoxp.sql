...
CREATE TABLE `movies` (
  ...
  CONSTRAINT `fk_movies_genres1` FOREIGN KEY (`genres_id`) REFERENCES `genres` (`genres_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `schedule` VALUES (1,20,'2020-12-15 08:00:00','2020-12-15 09:25:00',1),(2,74,'2020-12-15 10:00:00','2020-12-15 10:50:00',1),(3,25,'2020-10-15 11:00:00','2020-10-15 12:45:00',1),(4,125,'2020-10-15 13:00:00','2020-10-15 14:00:00',2),(5,225,'2020-12-15 14:15:00','2020-12-15 15:30:00',2);

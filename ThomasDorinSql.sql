...
-- -----------------------------------------------------
-- Cinema Table Creation -------------------------------
-- -----------------------------------------------------

CREATE TABLE `kinoxp`.`cinema` (
...
(1, '2020-10-15 10:00:00', '2020-10-15 11:25:00',1),
(2, '2020-10-15 12:00:00', '2020-10-15 12:50:00',1),
(3, '2020-10-15 13:00:00', '2020-10-15 14:45:00',1),
(4, '2020-10-15 15:00:00', '2020-10-15 16:00:00',2),
(5, '2020-10-15 16:15:00', '2020-10-15 17:30:00',3);
...
INSERT INTO `kinoxp`.`cinema` (`cinema_id`, `seats`) VALUES ('1', '40');
INSERT INTO `kinoxp`.`cinema` (`cinema_id`, `seats`) VALUES ('2', '70');
INSERT INTO `kinoxp`.`cinema` (`cinema_id`, `seats`) VALUES ('3', '12');

ALTER TABLE `kinoxp`.`schedule` 
ADD COLUMN `cinema_id` INT NULL AFTER `end`,
ADD INDEX `cinema_id_idx` (`cinema_id` ASC) VISIBLE;
;
ALTER TABLE `kinoxp`.`schedule` 
ADD CONSTRAINT `cinema_id`
  FOREIGN KEY (`cinema_id`)
  REFERENCES `kinoxp`.`cinema` (`cinema_id`)
  ON DELETE SET NULL
  ON UPDATE CASCADE;
